...
VALUES
    ("admin", "admin@outlook.com", "adminPWD", 5000, "System", "Admin", "0401111222", TRUE),
    ("hthompson", "hthompson@outlook.com", "P@ssw0rd1", 2000, "Hannah", "Thompson", "0401 234 567", FALSE),
    ("mmartin", "mmartin@outlook.com", "S3cur3P@ss", 3000, "Michael", "Martin", "0402 345 678", FALSE),
    ("jdoe", "jdoe@outlook.com", "An0th3rP@ss", 4000, "John", "Doe", "0403 456 789", FALSE),
    ("asmith", "asmith@outlook.com", "Yet@noth3r", 5000, "Alice", "Smith", "0404 567 890", FALSE),
    ("bjones", "bjones@outlook.com", "Last1P@ss", 6000, "Bob", "Jones", "0405 678 901", FALSE),
    ("ljohnson", "ljohnson@outlook.com", "S3cur3Pwd!", 7000, "Laura", "Johnson", "0406 789 012", FALSE),
    ("dlee", "davidlee@outlook.com", "MyP@ssw0rd2", 8000, "David", "Lee", "0407 890 123", FALSE),
    ("jwilson", "jwilson@outlook.com", "P@ssW0rd3!", 9000, "Julia", "Wilson", "0408 901 234", FALSE),
    ("kwhite", "kwhite@outlook.com", "4n0th3rPass", 1001, "Kevin", "White", "0409 012 345", FALSE),
    ("hmorris", "hmorris@outlook.com", "S@fePwd123", 2001, "Holly", "Morris", "0410 123 456", FALSE),
    ("ajames", "ajames@outlook.com", "StrongP@ss!", 3001, "Alex", "James", "0411 234 567", FALSE),
    ("bking", "bking@outlook.com", "P@ssw0rd4", 4001, "Brandon", "King", "0412 345 678", FALSE),
    ("kturner", "kturner@outlook.com", "S3curePwd5", 5001, "Karen", "Turner", "0413 456 789", FALSE),
    ...
    ("plewis", "plewis@outlook.com", "Y3tAn0th3r", 8001, "Peter", "Lewis", "0416 789 012", FALSE),
    ("staylor", "staylor@outlook.com", "L@stOne123", 9001, "Samantha", "Taylor", "0417 890 123", FALSE),
    ("jyoung", "jyoung@outlook.com", "P@ssWord!", 1002, "Jack", "Young", "0418 901 234", FALSE),
    ("tmorris", "tmorris@outlook.com", "NewP@ss123", 2002, "Tom", "Morris", "0419 012 345", FALSE),
    ("wmoore", "wmoore@outlook.com", "S3cur3It!", 3002, "Wendy", "Moore", "0420 123 456", FALSE),
    ("clong", "clong@outlook.com", "P@ssw0rd5", 4002, "Charlotte", "Long", "0421 234 567", FALSE),
    ("dlee2", "dlee2@outlook.com", "PassWord!2", 5002, "Danielle", "Lee", "0422 345 678", FALSE),
    ("aharris", "aharris@outlook.com", "P@ssw0rd6", 6002, "Aaron", "Harris", "0423 456 789", FALSE),
    ("kcollins", "kcollins@outlook.com", "MyNewP@ss", 7002, "Katherine", "Collins", "0424 567 890", FALSE),
    ("rthompson", "rthompson@outlook.com", "P@ssw0rd7", 8002, "Ryan", "Thompson", "0425 678 901", FALSE),
    ("ephillips", "ephillips@outlook.com", "S3cur3New!", 9002, "Emily", "Phillips", "0426 789 012", FALSE),
    ("lmurphy", "lmurphy@outlook.com", "S@f3Pwd!", 1003, "Laura", "Murphy", "0427 890 123", FALSE),
    ("jward", "jward@outlook.com", "L@stOne12", 2003, "James", "Ward", "0428 901 234", FALSE),
    ("ehall", "ehall@outlook.com", "N3wP@ssw0rd", 3003, "Evelyn", "Hall", "0429 012 345", FALSE),
    ("rking", "rking@outlook.com", "P@ss1234", 4003, "Rebecca", "King", "0430 123 456", FALSE);
